...
public class MeghMasterTeamMappingTest {
	...
	public void MPI_518_TeamMapping_01()  {
		...
		ArrayList<String> data = initBase.loadExcelData("Master_teammapping", currTC,
				"password,captcha,deptname,officename,mailinator,empid,empfirstname,emplastname,empemail,empphoneno,empjoiningdate,reportingto,enrollmentimage,state,teamname,pin,longitude");
...
//			}
		...
		if (EmployeePage.SearchTextField(empfirstname)) {
			logResults.createLogs("Y", "PASS",
					"Clicked On Search Text Field And Pass The Created Employee First Name Successfully." + empfirstname);
		} else {
			logResults.createLogs("Y", "FAIL",
					"Error while inputting On Search Text Field." + EmployeePage.getExceptionDesc());
		}
		...
		if (EmployeePage.SaveEnrollmentSuccessMsg()) {
			...
			Utils.propsReadWrite("data/addmaster.properties", "set", "AttendanceEmpid", empid);
		} else {
			logResults.createLogs("Y", "FAIL",
	...
	public void MPI_521_TeamMapping_04()  {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
		...
		ArrayList<String> data = initBase.loadExcelData("Master_teammapping", currTC,
				"deptname,officename,state,longitude");

		MeghMasterTeamMappingPage TeamMappingPage = new MeghMasterTeamMappingPage(driver);
	
		deptnamess = data.get(0) + Pramod.generateRandomAlpha(5);

		String officenamess = data.get(1) + Pramod.generateRandomAlpha(7);
		
		String state = data.get(2);
		String longitude = data.get(3);
	...
	public void MPI_522_TeamMapping_05()  {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
	...
	//	ArrayList<String> data = initBase.loadExcelData("Master_teammapping", currTC, "password,captcha");
 ...
 MeghLoginPage meghloginpage = new MeghLoginPage(driver);
	...
	public void MPI_528_TeamMapping_11()  {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
		...
		String teamnamess = data.get(0) + initBase.executionRunTime + Pramod.generateRandomAlpha(3);
 ...
 MeghLoginPage meghloginpage = new MeghLoginPage(driver);
	...
	public void MPI_529_TeamMapping_12()  {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
		...
		MeghMasterTeamMappingPage TeamMappingPage = new MeghMasterTeamMappingPage(driver);
		 ...
		 teamnamebeforeassigning = data.get(0) + Pramod.generateRandomAlpha(5); 
	...
	public void MPI_535_TeamMapping_16()  {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
	...
	public void MPI_533_TeamMapping_15()  {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
 ...
 MeghLoginPage meghloginpage = new MeghLoginPage(driver);
	...
	public void MPI_524_TeamMapping_07()  {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
