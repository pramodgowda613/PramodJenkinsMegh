...
import base.LoadDriver;
	...
	public class MeghPINightShiftAttendanceTest {
		...
		// MPI_879_Normal_Attendance_71
					...
					public void MPI_879_Normal_Attendance_71() {
						...
						logResults.setScenarioName("NightShift " + "Morning" +
		...
		// MPI_630_Normal_Attendance_02
				...
				public void MPI_630_Normal_Attendance_02()  {
					...
					logResults.createExtentReport(currTC);
					logResults.setScenarioName("NightShift " +
							"Check the status when the employee performs only a single punch in a day.");
					
					
					ArrayList<String> data = initBase.loadExcelData("NightShift_Attendance", currTC,
			...
			public void MPI_637_Normal_Attendance_09()  {
			 ...
			 // Get User Status
		        ...
		        if (validation.statusCode() == 200) {
		            ...
		            // Make sentence using excel inputs
		            String finalSentence = String.format(
		                "%s â€“ This Employee %s on %s, punched IN at %s and Punch OUT On %s at %s. Final Status = %s (Expected = %s)",
			...
			//MPI_644_Normal_Attendance_16
		        ...
		        if (validation.statusCode() == 200) {
					...
					public void MPI_440_Normal_Attendance_48()  {
					 ...
					 // Get User Status
				        ...
				        if (validation.statusCode() == 200) {
				            ...
				            // Make sentence using excel inputs
				            String finalSentence = String.format(
				                "%s â€“ This Employee %s on %s, punched IN at %s and Last Punch In On %s at %s. Final Status = %s (Expected = %s)",
				                description, employeeuniqueid, date, inouttime1, date2, secondInOutTime2, actualStatus, expectedStatus
				            );
					...
					public void MPI_442_Normal_Attendance_45()  {
					 ...
					 // Get User Status
				        ...
				        if (validation.statusCode() == 200) {
				            ...
				            // Make sentence using excel inputs
				            String finalSentence = String.format(
					                "%s â€“ This Employee %s on %s, punched IN at %s and Punch OUT On  %s at  %s and did Punch Out After 17hr On %s at %s . Final Status = %s (Expected = %s)",
					                description, employeeuniqueid, date, inouttime1, date2, secondInOutTime2,date2, thirdinouttime, actualStatus, expectedStatus
					            );
					...
					public void MPI_656_Normal_Attendance_44()  {
				        ...
				        LocalDate localDate = LocalDate.parse(date); 
						String date2 = localDate.plusDays(1).toString();
						 String firstDay = localDate.withDayOfMonth(1).toString();
					 ...
					 // Trigger attendance update first
					    Response updateResp = apiPage.executeUpdateAttendance(
					            ...
					            emailid, password, cmpcode,
					            baseuri, updateattendanceendpoint,  // <-- add endpoint in excel
					            employeeuniqueid, firstDay + "T00:00:00.000Z"
					    );
					...
					public void MPI_685_Normal_Attendance_31()  {
					 ...
					 // Get User Status
				        ...
				        if (validation.statusCode() == 200) {
				            ...
				            // Make sentence using excel inputs
				            String finalSentence = String.format(
				                "%s â€“ This Employee %s on %s, punched IN at %s and Punch OUT On %s at %s and Last Punch OUT at %s. Final Status = %s (Expected = %s)",
				                description, employeeuniqueid, date, inouttime1, date2, secondInOutTime2, thirdinouttime, actualStatus, expectedStatus
				            );
								...
								String photo = data.get(++i);
								 ...
								 String statusEndpoint    = data.get(++i);
							        ...
							        String toDateofstatus = date + toDateofuserstatus2; 
											...
											String inouttime = date2 + " " + inouttime1;
				...
				if (punchInResponse.getStatusCode() == 200) {
				    logResults.createLogs("N", "PASS", "Punch Out executed successfully at " + inouttime);
				} else {
		        ...
		        if (validation.statusCode() == 200) {
		            ...
		            String finalSentence = String.format(
		                ...
		                description, employeeuniqueid, date2, inouttime1, actualStatus, expectedStatus
		            );
					...
					public void MPI_697_Normal_Attendance_52()  {
					 ...
					 // Get User Status
				        ...
				        if (validation.statusCode() == 200) {
				            ...
				            // Make sentence using excel inputs
				            String finalSentence = String.format(
				                "%s â€“ This Employee %s on %s, punched IN On %s, at %s and Punch OUT On %s at %s. Final Status = %s (Expected = %s)",
				                description, employeeuniqueid, date, date2, inouttime1, date2, secondInOutTime2, actualStatus, expectedStatus
				            );
					...
					public void MPI_698_Normal_Attendance_53()  {
					 ...
					 // Trigger attendance update first
					    ...
					    if (updateResp.statusCode() == 200 && updateResp.jsonPath().getBoolean("IsSuccess")) {
					        logResults.createLogs("N", "PASS", "UpdateAttendance API executed successfully for " + employeeuniqueid + firstDay);
					    } else {
					        logResults.createLogs("N", "FAIL", "UpdateAttendance API failed." + updateResp.asString());
					    }
					    try {
					    ...
					    Response LeaveApplied = apiPage.executeCreateLeaves(
						 ...
						 // Get User Status
					        ...
					        if (validation.statusCode() == 200) {
					            ...
					            // Make sentence using excel inputs
					            String finalSentence = String.format(
					                "%s â€“ This Employee %s on %s, punched IN at %s and Punch OUT On %s at %s And Applied 2nd Half Leave. Final Status = %s (Expected = %s)",
					                description, employeeuniqueid, date, inouttime1, date2, secondInOutTime2, actualStatus, expectedStatus
					            );
					 ...
					 // Get User Status
				        ...
				        if (validation.statusCode() == 200) {
				            ...
				            String finalSentence = String.format(
				                ...
				                description, employeeuniqueid, date2, inouttime1, secondInOutTime2, actualStatus, expectedStatus
				            );
					...
					public void MPI_728_Normal_Attendance_56()  {
					 ...
					 // Get User Status
				        ...
				        if (validation.statusCode() == 200) {
				            ...
				            // Make sentence using excel inputs
				            String finalSentence = String.format(
				                "%s â€“ This Employee %s on %s, punched IN at %s and Punch OUT On %s at %s Applied 2nd Half Leave. Final Status = %s (Expected = %s)",
				                description, employeeuniqueid, date, inouttime1, date2, secondInOutTime2, actualStatus, expectedStatus
				            );
					...
					public void MPI_861_Normal_Attendance_70()  {
					 ...
					 // Load all data including punch-out time and mode
						...
						String thirdinouttime =  date2 + " " + thirdinouttime3;
						String fourthinouttime = date2 + " " + fourthinouttime4;
					 ...
					 // Get User Status
				        ...
				        if (validation.statusCode() == 200) {
				            ...
				            // Make sentence using excel inputs
				            String finalSentence = String.format(
				                "%s â€“ This Employee %s on %s, punched IN at %s and Punch OUT On %s at %s And Punch In at %s and Last Punch Out at %s. Final Status = %s (Expected = %s)",
				                description, employeeuniqueid, date, inouttime1, date2, secondInOutTime2, thirdinouttime, fourthinouttime, actualStatus, expectedStatus
				            );
					...
					public void MPI_652_Normal_Attendance_24()  {
					    String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
					    logResults.createExtentReport(currTC);
					    logResults.setScenarioName("NightShift " +"Check the status when the employee present on day");
					        ...
					        String punchOutTime = date2 + " " + secondInOutTime2;
					        String fromDateofstatus = date + fromDateofuserstatus1;
					        String toDateofstatus = date + toDateofuserstatus2;
