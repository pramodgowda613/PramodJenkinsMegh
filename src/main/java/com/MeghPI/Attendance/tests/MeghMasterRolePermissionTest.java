...
public class MeghMasterRolePermissionTest {
	...
	public void MPI_265_RolePermission_01() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
				"Check whether all active roles are displayed in the \"Select Role\" dropdown during the \"Add Role Permission\" process.");
	...
	public void MPI_267_RolePermission_03() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
				"Select \"owner\" as the role, assign only the \"General Settings\" permissions, and save. Then, click on Edit for the same role and validate whether only the assigned permissions are reflected correctly");
	...
	public void MPI_277_RolePermission_12() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
	...
	public void MPI_280_RolePermission_15() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
				"To verify this, assign Attendance permissions to an employee, then log in using that employee’s account and ensure that all Attendance-related options—My Regularization, My OT Approval, My Shift Request, and My Week Off Request—are displayed as per the assigned permissions.");
...
//enrolling the User
		...
		if (MeghLoginPage.LoginVerify(cmpcode, email, empid, captcha, logResults)) {
			logResults.createLogs("Y", "PASS", "Login Done Successfully: ");
		} else {
			logResults.createLogs("Y", "FAIL",
					"Login Is Failed: " + MeghLoginPage.getExceptionDesc());
	...
	public void MPI_281_RolePermission_16() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
				"To verify this, log in using the employee account where Leave module permissions have been assigned, and ensure that My Leave Request, Comp-off Request, and My Leave Balance are displayed as per the assigned permissions.");
	...
	public void MPI_282_RolePermission_17() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
				"To verify this, log in using the employee account and ensure that the following reports are displayed:In/Out Reports, Early & Late In/Out, Regularization Report, Overtime, Total Leaves Taken, Weekly Off Report, Punch Report, and Attendance Report.");
	...
	public void MPI_283_RolePermission_18() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
	...
	public void MPI_284_RolePermission_19() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
		...
		if (MeghLoginPage.LoginVerify(cmpcode, emailhr, empidhr, captcha, logResults)) {
			logResults.createLogs("Y", "PASS", "Login Done Successfully: ");
		} else {
			logResults.createLogs("Y", "FAIL",
					"Login Is Failed: " + MeghLoginPage.getExceptionDesc());
	...
	@Test(enabled = true, priority = 8, groups = { "Smoke" })
	public void MPI_285_RolePermission_20() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
	...
	public void MPI_286_RolePermission_21() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
	...
	public void MPI_287_RolePermission_22() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
	...
	public void MPI_288_RolePermission_23() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
