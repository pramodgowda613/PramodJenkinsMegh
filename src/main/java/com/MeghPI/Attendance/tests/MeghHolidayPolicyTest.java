...
public class MeghHolidayPolicyTest {
	...
	public void MPI_586_Holiday_Policy_01() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
				"To verify this, create a holiday policy by selecting 2024-2025 as duration year and ensure that the created policy is displayed in the employee profile.");

		ArrayList<String> data = initBase.loadExcelData("Holiday_Policy", currTC,
				"password,captcha,holidaypolicyname,year");

		
		String password = data.get(0);
		String captcha = data.get(1);
		holidaypolicyname = data.get(2) + initBase.executionRunTime + Pramod.generateRandomAlpha(3);
	...
	public void MPI_587_Holiday_Policy_02() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
...
MeghLoginTest meghlogintest = new MeghLoginTest();
	...
	public void MPI_590_Holiday_Policy_05() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
				"To verify this, edit the holiday policy and add another holiday and ensure added holiday is added to the policy ");
		...
		String password = data.get(0);
		String captcha = data.get(1);
		String UpdatedHolidayPolicyname = data.get(2) + Pramod.generateRandomAlpha(4);
		String year = data.get(3);
...
MeghLoginTest meghlogintest = new MeghLoginTest();
	...
	public void MPI_591_Holiday_Policy_06() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
		...
		ArrayList<String> data = initBase.loadExcelData("Holiday_Policy", currTC,
				"password,captcha,holidaypolicyname,year,holidayname,empjoiningdate");

		
		String password = data.get(0);
		String captcha = data.get(1);
		String holidaypolicynames = data.get(2) + initBase.executionRunTime + Pramod.generateRandomAlpha(3);
		String year = data.get(3);
		String holidayname = data.get(4) + initBase.executionRunTime + Pramod.generateRandomAlpha(3);
...
MeghLoginTest meghlogintest = new MeghLoginTest();
	...
	public void MPI_592_Holiday_Policy_07() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
		...
		ArrayList<String> data = initBase.loadExcelData("Holiday_Policy", currTC,
				"password,captcha,holidaypolicyname,year,holidayname");
...
MeghLoginTest meghlogintest = new MeghLoginTest();
	...
	public void MPI_593_Holiday_Policy_08() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
		...
		ArrayList<String> data = initBase.loadExcelData("Holiday_Policy", currTC,
				"password,captcha,holidaypolicyname,year,employeetype,reportingto,empid,empfirstname,emplastname,empemail,empphoneno,empjoiningdate,mailinator,Default");
		...
		String employeetype = data.get(++i);
...
//					String LoginEmailID = TestDataStore.emailids;
//					String LoginCompanyCode = TestDataStore.companycodes;
//					String LoginPassword = TestDataStore.confirmpassword;
...
MeghLoginTest meghlogintest = new MeghLoginTest();
	...
	public void MPI_594_Holiday_Policy_09() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
				"To verify this, create a user and assign them to the \"QC\" department with \"For Grade\" as the team, \"QC Head\" as the designation, and \"Staff\" as the employee type. Then, create a holiday Policy and define the same employee criteria within the policy. After saving the policy, ensure that the employee matching the specified criteria is correctly assigned to the newly created holiday  Policy, confirming that the policy assignment based on employee attributes is functioning as expected.");

		ArrayList<String> data = initBase.loadExcelData("Holiday_Policy", currTC,
				"password,captcha,holidaypolicyname,year,reportingto,empid,empfirstname,emplastname,empemail,empphoneno,empjoiningdate,mailinator,Default,pin");
...
MeghLoginTest meghlogintest = new MeghLoginTest();
	...
	public void MPI_595_Holiday_Policy_10() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
				"To verify this, inactivate the policy to which employees are assigned and ensure all the employees are reassigned to default policy ");

		ArrayList<String> data = initBase.loadExcelData("Holiday_Policy", currTC,
				"password,captcha,Default");
...
MeghLoginTest meghlogintest = new MeghLoginTest();
	...
	public void MPI_597_Holiday_Policy_11() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
				"To verify this, activate the policy and ensure again all the employees based on criteria are again fall under that created policy ");

		ArrayList<String> data = initBase.loadExcelData("Holiday_Policy", currTC, "password,captcha,year");
...
MeghLoginTest meghlogintest = new MeghLoginTest();
	...
	public void MPI_598_Holiday_Policy_12() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
...
MeghLoginTest meghlogintest = new MeghLoginTest();
	...
	// MPI_849_Holiday_Policy_13
		@Test(enabled = true, priority = 11, groups = { "Smoke", "AddMaster" })
		public void MPI_849_Holiday_Policy_13() throws InterruptedException {
			String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
			logResults.createExtentReport(currTC);
			logResults.setScenarioName(
