...
public class MeghAttendancePolicyTest {
	...
	public void MPI_434_Attendance_Policy_01()  {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
				"To verify this, click on \"add policy\" button and ensure \"add attendance policy\" form is displayed");

	//	ArrayList<String> data = initBase.loadExcelData("attendance_policy", currTC, "password,captcha");
 ...
 MeghLoginPage meghloginpage =  new MeghLoginPage(driver);
	...
	public void MPI_435_Attendance_Policy_02()  {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
		...
		ArrayList<String> data = initBase.loadExcelData("attendance_policy", currTC,
				"policyname,assignedemp,gracehours,duration");

		
		String policyname = data.get(0) + initBase.executionRunTime + Pramod.generateRandomAlpha(4);

		String assignedemp = data.get(1);
		String gracehours = data.get(2);
		String duration = data.get(3);
	...
	public void MPI_436_Attendance_Policy_03()  {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
		...
		ArrayList<String> data = initBase.loadExcelData("attendance_policy", currTC,
				"policyname,gracehours");

	
		String policyname = data.get(0) + initBase.executionRunTime + Pramod.generateRandomAlpha(3);
		String gracehours = data.get(1);
	...
	public void MPI_454_Attendance_Policy_21()  {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
		...
		ArrayList<String> data = initBase.loadExcelData("attendance_policy", currTC,
				"policyname,mailinator,empid,empfirstname,emplastname,empemail,empphoneno,empjoiningdate,reportingto,enrollmentimage,pin,gracehours,duration");
		...
		if (AttendancePolicyPage.AssignedAttendancePolicyComparisons(policynames)) {
	...
	public void MPI_457_Attendance_Policy_24()  {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults
	...
	public void MPI_494_Attendance_Policy_44()  {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
		...
		ArrayList<String> data = initBase.loadExcelData("attendance_policy", currTC,
				"assignedemp,policyname");

		
		
		
		String assignedemp = data.get(0);
		String defaultpolicy = data.get(1);
	 ...
	 MeghLoginPage meghloginpage =  new MeghLoginPage(driver);
		...
		if (AttendancePolicyPage.AssignedAttendancePolicyComparisons(defaultpolicy)) {
	...
	public void MPI_496_Attendance_Policy_46()  {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
	...
	public void MPI_498_Attendance_Policy_48()  {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
		...
		ArrayList<String> data = initBase.loadExcelData("attendance_policy", currTC,
				"policyname,mailinator,empid,empfirstname,emplastname,empemail,empphoneno,empjoiningdate,reportingto,pin,gracehours,duration");
	...
	public void MPI_499_Attendance_Policy_49()  {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
		...
		ArrayList<String> data = initBase.loadExcelData("attendance_policy", currTC,
				"policyname,mailinator,empid,empfirstname,emplastname,empemail,empphoneno,empjoiningdate,reportingto,enrollmentimage,pin,emptwo,gracehours,duration");
...
//creating new user
	...
	@Test(enabled = true, priority = 6, groups = { "Smoke" })
	public void MPI_502_Attendance_Policy_51()  {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
	...
	public void MPI_503_Attendance_Policy_52()  {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
		...
		ArrayList<String> data = initBase.loadExcelData("attendance_policy", currTC,
				"policyname,mailinator,empid,empfirstname,emplastname,empemail,empphoneno,empjoiningdate,reportingto,enrollmentimage,gracehours,duration");
...
//enrolling the User
	...
	// MPI_846_Attendance_Policy_71
		...
		public void MPI_846_Attendance_Policy_71()  {
			String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
			logResults.createExtentReport(currTC);
			logResults.setScenarioName(
			...
			ArrayList<String> data = initBase.loadExcelData("attendance_policy", currTC,
					"password,captcha,policyname,gracehours,othours,duration");
		...
		String duration = data.get(i++);
			...
			if (AttendancePolicyPage.AddAttendanceValidation()) {
				Utils.propsReadWrite("data/addmaster.properties", "set", "AttenPolicyName", "pass");
				logResults.createLogs("Y", "PASS", "Attendance Policy Created Successfully .");
			} else {
				logResults.createLogs("Y", "FAIL",
						"Error While Creating New Attendance Policy ." + AttendancePolicyPage.getExceptionDesc());
			}
