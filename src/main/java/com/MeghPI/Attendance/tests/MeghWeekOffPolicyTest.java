...
public class MeghWeekOffPolicyTest {
	...
	public void MPI_576_WeekOff_Policy_01() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
				"To verify this, add a Week Off Policy by selecting 2nd Half on Thursday and Full Day on Friday, then make the policy active. When the system prompts with the message \"Do you want to change weekly-off policy in Employee Profile based on current policy employee criteria?\", select \"Yes\". Finally, ensure that all applicable employees are assigned to the newly created Week Off Policy based on the defined criteria.");
		...
		weekoffpolicyname = data.get(2) + initBase.executionRunTime + Pramod.generateRandomAlpha(3);
...
MeghLoginTest meghlogintest = new MeghLoginTest();
	...
	public void MPI_577_WeekOff_Policy_02() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
...
MeghLoginTest meghlogintest = new MeghLoginTest();
	...
	public void MPI_578_WeekOff_Policy_03() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
		...
		ArrayList<String> data = initBase.loadExcelData("week_off_policy", currTC,
				"password,captcha,weekoffpolicyname,mailinator,empid,empfirstname,emplastname,empemail,empphoneno,empjoiningdate,reportingto,enrollmentimage,pin");
...
//enrolling the User
	...
	@Test(enabled = true, priority = 4, groups = { "Smoke" })
	public void MPI_579_WeekOff_Policy_04() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
		...
		ArrayList<String> data = initBase.loadExcelData("week_off_policy", currTC,
				"password,captcha,weekoffpolicyname,mailinator,empid,empfirstname,emplastname,empemail,empphoneno,empjoiningdate,reportingto,enrollmentimage,pin,Default");
...
MeghLoginTest meghlogintest = new MeghLoginTest();
	...
	public void MPI_581_WeekOff_Policy_06() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
...
MeghLoginTest meghlogintest = new MeghLoginTest();
	...
	public void MPI_582_WeekOff_Policy_07() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
...
MeghLoginTest meghlogintest = new MeghLoginTest();
	...
	public void MPI_584_WeekOff_Policy_09() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
	...
	public void MPI_585_WeekOff_Policy_10() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
...
MeghLoginTest meghlogintest = new MeghLoginTest();
	...
	// MPI_848_WeekOff_Policy_12
		@Test(enabled = true, priority = 9, groups = { "Smoke", "AddMaster" })
		public void MPI_848_WeekOff_Policy_12() throws InterruptedException {
			String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
			logResults.createExtentReport(currTC);
			logResults.setScenarioName(
