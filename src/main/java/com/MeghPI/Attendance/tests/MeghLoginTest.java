...
public class MeghLoginTest {
	...
	public void MPI_1_Login_Page_01() {
	...
	// MPI_2_Login_Page_02
	@Test(enabled = false, priority = 2, groups = { "Sanity" })
	public void MPI_2_Login_Page_02() {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
	...
	public void MPI_3_Login_Page_03() {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
	...
	public void MPI_4_Login_Page_04() {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
		...
		if (meghLoginPage.PhoneNumber(phonenumbers)) {
			...
			logResults.createLogs("Y", "FAIL", "Error While Entering Phone Number." + meghLoginPage.getExceptionDesc());
		}
		...
		if (meghLoginPage.CompanyName(companyname + initBase.executionRunTime)) {
			...
			logResults.createLogs("Y", "FAIL", "Error While Entering Company Name." + meghLoginPage.getExceptionDesc());
		}

		if (meghLoginPage.enterCompanyCode(companycode)) {
			logResults.createLogs("Y", "PASS", "Company Code Entered in Text Box." + companycode);
		} else {
			logResults.createLogs("Y", "FAIL", "Error While Entering Company Code." + meghLoginPage.getExceptionDesc());
		}
		...
		if (meghLoginPage.CardCVV(cardcvv)) {
			...
			logResults.createLogs("Y", "FAIL", "Error While Entering The Card CVV." + meghLoginPage.getExceptionDesc());
		}
		...
		if (meghLoginPage.PrimaryContactName(firstname)) {
			...
			logResults.createLogs("Y", "FAIL", "Error While Entering Contact Name." + meghLoginPage.getExceptionDesc());
		}
		...
		if (meghLoginPage.AddOffice()) {
			...
			logResults.createLogs("Y", "FAIL", "Error While Clicking On AddOffice." + meghLoginPage.getExceptionDesc());
		}
		...
		if (meghLoginPage.TimeFormat()) {
			...
			logResults.createLogs("Y", "FAIL", "Error While Selecting  TimeFormat." + meghLoginPage.getExceptionDesc());
		}
		...
		if (meghLoginPage.SignupValidation()) {
			...
			Utils.propsReadWrite("data/addmaster.properties", "set", "AdminFirstName", firstname);
			Utils.propsReadWrite("data/addmaster.properties", "set", "AdminEmpID", deptname);
		} else {
		...
		if (meghLoginPage.loginWithOtpUserName(emailids)) {
			...
			logResults.createLogs("Y", "FAIL", "Error While Entering The Username." + meghLoginPage.getExceptionDesc());
		}
	...
	public void MPI_7_Login_Page_07() {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
	...
	// MPI_8_Login_Page_08
	@Test(enabled = false, priority = 8, groups = { "Sanity" })
	public void MPI_8_Login_Page_08() {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
	...
	// MPI_9_Login_Page_09
	@Test(enabled = false, priority = 9, groups = { "Sanity" })
	public void MPI_9_Login_Page_09() {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
	...
	@Test(enabled = false, priority = 10, groups = { "Sanity" })
	public void MPI_10_Login_Page_10() {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
	...
	@Test(enabled = false, priority = 11, groups = { "Sanity" })
	public void MPI_11_Login_Page_11() {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
	...
	// MPI_12_Login_Page_12Â 
	@Test(enabled = false, priority = 12, groups = { "Smoke" })
	public void MPI_12_Login_Page_12() {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
	...
	// MPI_13_Login_Page_13Â 
	@Test(enabled = false, priority = 13, groups = { "Sanity" })
	public void MPI_13_Login_Page_13() {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
	...
	public void MPI_14_Login_Page_14() {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
...
//MPI_15_Login_Page_15
	@Test(enabled = false, priority = 15, groups = { "Sanity" })
	public void MPI_15_Login_Page_15() {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
...
//MPI_16_Login_Page_16
	@Test(enabled = false, priority = 16, groups = { "Sanity" })
	public void MPI_16_Login_Page_16() {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
	...
	public void MPI_49_Login_Page_18() {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
	...
	@Test(enabled = false, priority = 19, groups = { "Sanity" })
	public void MPI_137_Login_page_19() {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
	...
	@Test(enabled = false, priority = 20, groups = { "Sanity" })
	public void MPI_138_Login_page_20() {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
	...
	// MPI_139_Login_page_21Â 
	@Test(enabled = false, priority = 21, groups = { "Smoke" })
	public void MPI_139_Login_page_21() {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
		...
		if (meghLoginPage.NewPassword(password)) {
			...
			logResults.createLogs("Y", "FAIL", "Error While Inputing New Password." + meghLoginPage.getExceptionDesc());
		}
	...
	// MPI_140_Login_page_22Â 
	@Test(enabled = false, priority = 22, groups = { "Sanity" })
	public void MPI_140_Login_page_22() {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
	...
	// MPI_141_Login_page_23Â 
	@Test(enabled = false, priority = 23, groups = { "Sanity" })
	public void MPI_141_Login_page_23() {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
	...
	public void MPI_144_Login_Page_26() {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
