...
public class MeghMasterGradeTest {
	...
	public void MPI_289_Grade_01() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
				"Create a newÂ GradeÂ and ensure that theÂ created GradeÂ is displayed in theÂ Grade dropdownÂ under theÂ Employee/User Manage ProfileÂ section");
...
MeghLoginTest meghlogintest = new MeghLoginTest();
	...
	public void MPI_290_Grade_02() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
		...
		String gradename = data.get(2) + Pramod.generateRandomNumber(4);
...
MeghLoginTest meghlogintest = new MeghLoginTest();
	...
	public void MPI_292_Grade_04() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults
...
MeghLoginTest meghlogintest = new MeghLoginTest();
	...
	public void MPI_298_Grade_10() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
...
MeghLoginTest meghlogintest = new MeghLoginTest();
	...
	public void MPI_299_Grade_11() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
...
MeghLoginTest meghlogintest = new MeghLoginTest();
	...
	public void MPI_300_Grade_12() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
