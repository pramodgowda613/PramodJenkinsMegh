...
public class MeghEmployeeTest {
	...
	public void MPI_145_Directory_AddEmployee_01()  {
	...
	public void MPI_146_Directory_AddEmployee_02()  {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
	...
	//	ArrayList<String> data = initBase.loadExcelData("employee", currTC,	"password,captcha,message,entityname");
	...
	public void MPI_148_Directory_AddEmployee_03()  {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
		...
		//ArrayList<String> data = initBase.loadExcelData("employee", currTC, "password,captcha");
...
if (meghloginpage.MainLandingPage()) {
	...
	public void MPI_149_Directory_AddEmployee_04()   {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
...
if (meghloginpage.MainLandingPage()) {
	...
	public void MPI_150_Directory_AddEmployee_05()  {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
		...
		ArrayList<String> data = initBase.loadExcelData("employee", currTC,
				"reportingto,empid,empfirstname,emplastname,empemail,empphoneno,mailinator,empjoiningdate");

		MeghMasterEmployeePage EmployeePage = new MeghMasterEmployeePage(driver);

		String reportingto = data.get(0);
		String empid = data.get(1) + Pramod.generateRandomAlpha(5);
		

		String empfirstname = data.get(2) + Pramod.generateRandomAlpha(6);
		 emplastname = data.get(3) + Pramod.generateRandomAlpha(5);
		String empemail = data.get(4);
		String empphoneno = data.get(5) + Pramod.generateRandomNumber(5);
		String mailinator = data.get(6);
		String email = empemail + initBase.executionRunTime + Pramod.generateRandomAlpha(3) + mailinator;
		String joiningdate = data.get(7);
...
if (meghloginpage.MainLandingPage()) {
	...
	public void MPI_159_Directory_AddEmployee_14()  {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
		...
		String enrollmentimage = data.get(0);
...
if (meghloginpage.MainLandingPage()) {
	...
	logResults.createLogs("Y", "FAIL",
		...
		public void MPI_626_Directory_AddEmployee_19() {
			String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
			logResults.createExtentReport(currTC);
			logResults.setScenarioName(
