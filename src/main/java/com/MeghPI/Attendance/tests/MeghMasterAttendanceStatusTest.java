...
public class MeghMasterAttendanceStatusTest {
	...
	public void MPI_321_AttendanceStatus_01() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
				"To verify this, edit the attendance status and ensure the updated status is reflected in the list by validating it using the cust status.");
	...
	public void MPI_322_AttendanceStatus_02() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
