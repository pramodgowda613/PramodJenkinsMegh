...
public class MeghShiftPolicyTest {
	...
	public void MPI_478_Shift_Policy_01() throws InterruptedException {
		...
		String shiftpolicyname = data.get(2) + initBase.executionRunTime + Pramod.generateRandomAlpha(3);
...
MeghLoginTest meghlogintest = new MeghLoginTest();
	...
	// MPI_479_Shift_Policy_02
	@Test(enabled = true, priority = 2, groups = { "Smoke" })
	public void MPI_479_Shift_Policy_02() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
		...
		ArrayList<String> data = initBase.loadExcelData("shift_policy", currTC,
				"password,captcha,shiftname,shiftcode,starttime,endtime,buffertime,fullday,halfday");

	
		String password = data.get(0);
		String captcha = data.get(1);
		
		String shiftname = data.get(2)  + Pramod.generateRandomAlpha(4);
...
//enrolling the User
	...
	public void MPI_481_Shift_Policy_04() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
				"To verify this, ensure that the policy name is displayed in the employee profile when the policy matches the employee’s company, office name, designation, and groups.");
...
MeghLoginTest meghlogintest = new MeghLoginTest();
	...
	public void MPI_483_Shift_Policy_06() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
	...
	public void MPI_486_Shift_Policy_09() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
		...
		ArrayList<String> data = initBase.loadExcelData("shift_policy", currTC,
				"password,captcha,shiftpolicyname,assignedemp");
		...
		String defaultpolicys = data.get(2);
...
MeghLoginTest meghlogintest = new MeghLoginTest();
	...
	public void MPI_487_Shift_Policy_10() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
...
MeghLoginTest meghlogintest = new MeghLoginTest();
	...
	public void MPI_489_Shift_Policy_12() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
		...
		ArrayList<String> data = initBase.loadExcelData("shift_policy", currTC,
				"password,captcha,shiftpolicyname,mailinator,empid,empfirstname,emplastname,empemail,empphoneno,empjoiningdate,reportingto,enrollmentimage,shiftname");
...
//enrolling the User
	...
	public void MPI_491_Shift_Policy_14() throws InterruptedException {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
...
MeghLoginTest meghlogintest = new MeghLoginTest();
	...
	// MPI_850_Shift_policy_22
		...
		public void MPI_850_Shift_policy_22() throws InterruptedException {
			String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
			logResults.createExtentReport(currTC);
			logResults.setScenarioName(
