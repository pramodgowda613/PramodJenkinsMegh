...
public class MeghLeavePolicyTest {
	...
	public void MPI_544_Leave_Policy_01()  {
		...
		ArrayList<String> data = initBase.loadExcelData("leave_policy", currTC,
				"leavepolicyname,sickleave,travelleave,casualleave");

		String leavepolicynames = data.get(0) + initBase.executionRunTime + Pramod.generateRandomAlpha(3);
		String sickleave = data.get(1);
		String travelleave = data.get(2);
		String casualleave = data.get(3);
...
if (meghloginpage.MainLandingPage()) {
	...
	public void MPI_545_Leave_Policy_02()  {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
		...
		ArrayList<String> data = initBase.loadExcelData("leave_policy", currTC,
				"leavepolicyname,mailinator,empid,empfirstname,emplastname,empemail,empphoneno,empjoiningdate,reportingto,enrollmentimage,sickleave,defaulttext");
...
//enrolling the User
	...
	public void MPI_546_Leave_Policy_03()  {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
		...
		ArrayList<String> data = initBase.loadExcelData("leave_policy", currTC,
				"leavepolicyname,mailinator,empid,empfirstname,emplastname,empemail,empphoneno,empjoiningdate,reportingto,enrollmentimage,sickleave,pin");
...
//enrolling the User
	...
	public void MPI_547_Leave_Policy_04()  {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
...
if (meghloginpage.MainLandingPage()) {
	...
	logResults.createLogs("Y", "FAIL",
		...
		if (LeavePolicyPage.AssignedEmpCount(assignedemp)) {
			...
			logResults.createLogs("Y", "PASS", "Created Policy Name Displayed Successfully." + assignedemp + " " + assignempcountno);
		} else {
			logResults.createLogs("Y", "FAIL",
					"Error While Displaying Created Leave Policy Name." + LeavePolicyPage.getExceptionDesc());
		}
	...
	public void MPI_548_Leave_Policy_05()  {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
	...
	//	ArrayList<String> data = initBase.loadExcelData("leave_policy", currTC,	"password,captcha");
	...
	public void MPI_549_Leave_Policy_06()  {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
	...
	public void MPI_556_Leave_Policy_13()  {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
		...
		String leavename = data.get(0) + initBase.executionRunTime + Pramod.generateRandomAlpha(3);
...
if (meghloginpage.MainLandingPage()) {
	...
	public void MPI_558_Leave_Policy_15()  {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
		...
		ArrayList<String> data = initBase.loadExcelData("attendance_policy", currTC,
				"leavepolicyname,mailinator,empid,empfirstname,emplastname,empemail,empphoneno,empjoiningdate,reportingto,enrollmentimage,pin,emptwo,sickleave");
...
//creating new user
	...
	public void MPI_561_Leave_Policy_18()  {
		String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
		logResults.createExtentReport(currTC);
		logResults.setScenarioName(
		...
		//ArrayList<String> data = initBase.loadExcelData("leave_policy", currTC,"password,captcha,defaulttext,assignedemp");
...
if (meghloginpage.MainLandingPage()) {
	...
	// MPI_847_Leave_Policy_37
		...
		public void MPI_847_Leave_Policy_37()  {
			String currTC = Thread.currentThread().getStackTrace()[1].getMethodName();
			logResults.createExtentReport(currTC);
			logResults.setScenarioName(
			...
			ArrayList<String> data = initBase.loadExcelData("leave_policy", currTC,
					"password,captcha,leavepolicyname,sickleave,travelleave,casualleave,leavename,leavecode,leavedescription");
			...
			String leavename = data.get(i++) + initBase.executionRunTime;
			String leavecode = data.get(i++) + Pramod.generateRandomNumber(3);
			String leavedescription = data.get(i++) + initBase.executionRunTime;;
	...
	MeghMasterEmployeePage EmployeePage = new MeghMasterEmployeePage(driver);
			...
			if (LeaveTypePage.UnpaidRadioButton()) {
				logResults.createLogs("Y", "PASS", "Unpaid Radio Button Clicked  Successfully.");
			} else {
				logResults.createLogs("Y", "FAIL",
						"Error while Clicking On Unpaid Radio Button ." + LeaveTypePage.getExceptionDesc());
			}
			...
			if (LeavePolicyPage.AllLeaves4(leavename)) {

				logResults.createLogs("Y", "PASS", "Unpaid Leave Selected Successfully." + leavename);
			} else {
				logResults.createLogs("Y", "FAIL",
						"Error While Selecting Unpaid Leave." + LeavePolicyPage.getExceptionDesc());
			}
